...
echo '<option value="'.$data_kelas['id_kelas'].'" '.$selek.'>'.$data_kelas['nama_kelas'].'</option>';   
        ...
        Username : 
<input type="text" name="usernamee" value="<?=$dt_siswa['usernamee']?>" class="form-control">
        Password : 
<input type="password" name="password" value="" class="form-control">
<button type="submit" name="simpan" value="Tambah Siswa" class="btn btn-primary" aria-label='Submit form to Add student'>Ubah siswa</button>
    </form>
